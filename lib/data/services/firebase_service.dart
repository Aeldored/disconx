...
class FirebaseService {
  ...
  Future<WhitelistData?> fetchCurrentWhitelist() async {
    ...
    try {
      ...
      // Download full whitelist from Storage
      try {
        final ref = _storage.ref('whitelists/current/whitelist_latest.json');
        ...
        final accessPoints = (jsonData['accessPoints'] as List)
            .map((ap) => AccessPointData.fromJson(ap))
            .toList();
